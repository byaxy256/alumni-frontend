...
import { ArrowLeft, AlertCircle, CheckCircle2, Info, AlertTriangle, FileText, DollarSign, Loader2, Users } from 'lucide-react';
...
export function AlumniNotifications({ user, onBack }: AlumniNotificationsProps) {
  ...
  const getIcon = (title: string | undefined) => {
    ...
    if (titleLower.includes('request') || titleLower.includes('student')) {
      return <Users size={20} className="text-blue-600" />;
    } else if (titleLower.includes('message')) {
      return <Info size={20} className="text-blue-600" />;
    } else if (titleLower.includes('approved') || titleLower.includes('success')) {
