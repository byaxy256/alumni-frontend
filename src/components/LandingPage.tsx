...
export default function LandingPage({ onGetStarted, onLogin }: LandingPageProps) {
  ...
  return (
    <div className="min-h-screen relative overflow-hidden bg-gradient-to-br from-[#0b1a2f] via-[#0b1a2f] to-[#0f2a44] text-white">
      <div
      ...
      <div className="relative z-10 min-h-screen flex flex-col">
        <header className="px-6 py-4 border-b border-white/10">
          <div className="max-w-7xl mx-auto flex justify-between items-center">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-lg font-semibold">Alumni Aid</h1>
        ...
        <section className="flex-1 flex items-center justify-center px-6 py-20">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="text-4xl md:text-6xl mb-6 leading-tight font-semibold">
              Empower Students,
              <br />
